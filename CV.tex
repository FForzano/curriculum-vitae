...
\begin{europasscv}
    ...
    \ecvtitle{2024}{Titolare di incarico di lavoro autonomo ``Study of quantum systems for sensing''}
    \ecvitem{Azienda o Ente}{Università degli Studi di Ferrara}
    \ecvitem{Descrizione}{Incarico di lavoro autonomo di tipo occasionale per
conto del \englishText{\textbf{WCLN Laboratory}} del Dipartimento di Ingegneria
con oggetto ``Study of quantum systems for sensing''.}
    ...
    \ecvitem{Descrizione}{Preparazione e svolgimento di laboratori didattici per
        ...
        laurea in Ingegneria Elettronica e Informatica (L-8) e in Informatica (L-31),
        dell'Università degli Studi di Ferrara, negli
        anni 2024 e 2025.}
    % Tirocinio
    \ecvtitle{2023 - oggi}{Correlatore di tesi}
    \ecvitem{Descrizione}{ Affiancamento di alcuni studenti nei tirocini interni
        all'università (internati) e attività di correlatore per le rispettive tesi.}
